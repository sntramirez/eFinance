...
mongoose.connect('mongodb+srv://'+ process.env.MONGO_ATLAS_USERMAME +':' + process.env.MONGO_ATLAS_PWD + '@efinancetest.m4hngbn.mongodb.net/efinancetest?retryWrites=true&w=majority')
  .then(() => {
